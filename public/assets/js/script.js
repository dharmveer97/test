! function (i) {
	...
	function e() {
		var o = document.querySelector(".scroll-progress path"),
			s = o.getTotalLength();
		o.style.transition = o.style.WebkitTransition = "none", o.style.strokeDasharray = s + " " + s, o.style.strokeDashoffset = s, o.getBoundingClientRect(), o.style.transition = o.style.WebkitTransition = "stroke-dashoffset 10ms linear";
	...
	i.fn.nextOrFirst = function (e) {
		...
		t = 0, window.onscroll = function () {
			...
			var e;
			s(), e = 0 + i(window).scrollTop() / 3 + "deg", i(".user-image .shape").css({
		...
		var t, o, e;
		(t = new Swiper(".portfolio-carousel-fluid .swiper-container", {
			slidesPerView: 2,
			spaceBetween: 0,
			speed: 600,
			loop: !0,
			...
			var e = t.realIndex;
			i(".activeslide").html("0" + (e + 1))
		}), (o = new Swiper(".review-carousel .swiper-container", {
			slidesPerView: 1,
			spaceBetween: 0,
			speed: 600,
			loop: !1,
		...
		}), i(".mesonaryInit").isotope(), i(".floating-info-block").each(function () {
			i(this).on("mouseenter", function () {
				i(this).data("title") && (i(".floating-info-block-tile").html('<span class="card-subtitle font-weight-500 small mb-1">' + i(this).data("category") + '</span><h4 class="card-title mb-0 font-weight-bold">' + i(this).data("title") + "</h4>"), i(".floating-info-block-tile").addClass("visible")), i(document).on("mousemove", function (e) {
			...
			i(this).on("mouseenter", function () {
				i(this).addClass("enter"), i(document).on("mousemove", function (e) {
		...
		}), e = i(".fade-slider .slider-item:eq(0)").height(), i(".fade-slider").css("height", e), i(".fade-slider .slider-item:eq(0)").addClass("active"), i(".fade-slider .slider-item:gt(0)").hide(), setInterval(function () {
			i(".active:eq(0)").fadeOut(1e3).removeClass("active").nextOrFirst(".slider-item").addClass("active").fadeIn(1e3).end()
		}, 3e3), s()
	})
}(jQuery);